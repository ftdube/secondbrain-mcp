...
| `BLK` | FR-BLK-1, FR-BLK-2, FR-BLK-3, FR-BLK-4, FR-BLK-5 (all as of v1.7) | NFR-BLK-1, NFR-BLK-2, NFR-BLK-3 (architectural/config-timing properties, demonstrated by construction and by the unchanged pre-existing suite rather than by a dedicated test) |
